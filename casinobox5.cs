...
public class casinobox5 : MonoBehaviour
{
    ...
    public void ok()
    {
        if (finalDrops.sprite.name.Equals("130k"))
        {
            cs.score = cs.score + 130000;
        }
        if (finalDrops.sprite.name.Equals("65k"))
        {
            cs.score = cs.score + 65000;
        }
        if (finalDrops.sprite.name.Equals("50lvl"))
        {
            cs.lvl = cs.lvl + 50;
        }
        if (finalDrops.sprite.name.Equals("50pps"))
        {
            cs.countpot3 = cs.countpot3 + 50;
        }
        if (finalDrops.sprite.name.Equals("extralvl"))
        {
            cs.extralvl = cs.extralvl + 1;
        }
        if (finalDrops.sprite.name.Equals("250k"))
        {
            cs.score = cs.score + 250000;
        }
        Invoke("zd", 0.1f);
    }
